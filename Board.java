...
public class Board {
	...
	public static ArrayList<Zone> movementBoard = new ArrayList<>();
	 ...
	 */
	public static ArrayList<Zone> movementBoard() {
	...
	public static boolean checkZone(Player currentPlayer) {
		...
		Zone currentArea = movementBoard.get(currentPlayer.getPosition());
