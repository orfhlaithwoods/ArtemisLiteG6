...
public class GameAdmin {
	...
	/**
	 * Removes a player from the game and reassigns all of their resources to NASA, then prints a list of the remaining players
	 * @param currentPlayer
	 * @param players
	 */
	...
	public static void displayTitle() {
		...
		System.out.println("   _____          __                 .__         .____    .__  __          \r\n"
				...
				+ "        \\/                 \\/      \\/        \\/          \\/             \\/ ");
		System.out.println("\t\t  A game by Ryan, Orfhlaith and Caolan.");
		System.out.println();
	 ...
	 * @param movementBoard
	 */
	public static void playerMovement(Player currentPlayer, ArrayList<Square> movementBoard) {
