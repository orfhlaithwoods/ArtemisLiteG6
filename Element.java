...
public class Element extends Area {
	...
	public Element(eSpaceSystem system, String name, int location, Player sysOwner, int blueprintCost, int devOneCost, int devTwoCost,
			...
			int developmentLevel, Player owner, int maxInGroup) {

		// inherited attributes from System superclass
		super(system, name, location);
